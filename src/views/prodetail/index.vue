      ...
      <div class="comment-list">
        <div class="comment-item" v-for="item in commentList" :key="item.comment_id">
          <div class="top">
           ...
           <div :size="16" :value="item.score/2" color="#ffd21e" void-icon="star" void-color="#eee"></div>
          </div>
          <div class="content">
            {{ item.content }}
          </div>
  ...
  <div class="product">
    <div class="product-title">
      ...
      <div class="right">
        ...
        <div class="count">
          <span>库存{{ detail.stock_total }}</span>
          <span>55</span>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    //     })
    //       .then(() => {
    //         // 如果希望跳转到登录页，=》登录后还能跳转回来，需要再跳转去携带参数（当前的路径地址）
    //         // this.$route.fullPath这个会包含查询参数的
    //         this.$router.replace({
    //           path: '/login',
    //           query: {
